...
public class MordernWeb extends JFrame implements ActionListener {
...
public MordernWeb(){
    setDefaultCloseOperation(EXIT_ON_CLOSE);
        setSize(800,800);
        setTitle("Mordern Web Questions");
        setVisible(true);
     ...
     if(ae.getSource()==btndone)
        {
           ...
           JOptionPane.showMessageDialog(null,"Field is left blank!");
            ...
            try {
                ...
                int ans=data.mordernWebQstn(tfield3.getText(),tfield1.getText(),tfield2.getText(),tfield4.getText(),tfield5.getText(),tfield6.getText());
//questions are sent in database's mordernWebQStn function
