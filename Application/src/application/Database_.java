...
public class Database_ extends JFrame implements ActionListener {
     ...
     if(ae.getSource()==btndone)
        {
           ...
           JOptionPane.showMessageDialog(null,"Field is left blank!");
            ...
            try {
                ...
                int ans=data.databaseQstn(tfield3.getText(),tfield1.getText(),tfield2.getText(),tfield4.getText(),tfield5.getText(),tfield6.getText());
