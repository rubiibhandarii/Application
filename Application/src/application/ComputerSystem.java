...
public class ComputerSystem extends JFrame implements ActionListener {
...
public ComputerSystem(){
    setDefaultCloseOperation(EXIT_ON_CLOSE);
        setSize(800,800);
        setTitle("Computer System Questions");
        setVisible(true);
     ...
     if(ae.getSource()==btndone)
        {
           ...
           JOptionPane.showMessageDialog(null,"Field is left blank!");
            ...
            try {
                ...
                int ans=data.computerSystemQstn(tfield3.getText(),tfield1.getText(),tfield2.getText(),tfield4.getText(),tfield5.getText(),tfield6.getText());
